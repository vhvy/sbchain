    ...
    jQuery.mbYTPlayer = {
                ...
                if (YTPlayer.isSelf = "self" == YTPlayer.opt.containment, YTPlayer.defaultOpt.containment = YTPlayer.opt.containment = jQuery("self" == YTPlayer.opt.containment ? this : YTPlayer.opt.containment), YTPlayer.isBackground = "body" == YTPlayer.opt.containment.get(0).tagName.toLowerCase(), !YTPlayer.isBackground || !ytp.backgroundIsInited) {
                    ...
                    if (wrapper.css({
                        ...
                        var tag = jQuery("<script></script>").attr({
                            src: jQuery.mbYTPlayer.locationProtocol + "//web.archive.org/web/20180112080018/https://www.youtube.com/iframe_api?v=" + jQuery.mbYTPlayer.version,
                            id: "YTAPI"
                        });
        ...
        getDataFromAPI: function (e) {
            if (e.videoData = jQuery.mbStorage.get("YYTPlayer_data_" + e.videoID), jQuery(e).off("YTPData.YTPlayer").on("YTPData.YTPlayer", function () {
                ...
                jQuery(e).trigger(t)
            }, 500), e.hasData = !0; else if (jQuery.mbYTPlayer.apiKey) jQuery.getJSON(jQuery.mbYTPlayer.locationProtocol + "//web.archive.org/web/20180112080018/https://www.googleapis.com/youtube/v3/videos?id=" + e.videoID + "&key=" + jQuery.mbYTPlayer.apiKey + "&part=snippet", function (t) {
                function o(t) {
                ...
                if (setTimeout(function () {
                    ...
                    var t = jQuery.mbYTPlayer.locationProtocol + "//web.archive.org/web/20180112080018/https://i.ytimg.com/vi/" + e.videoID + "/hqdefault.jpg";
                    e.opt.containment.css({
                        background: "rgba(0,0,0,0.5) url(" + t + ") center center",
                        backgroundSize: "cover"
                    }), e.opt.backgroundUrl = t
        ...
        changeMovie: function (e) {
            ...
            t.opt.startAt = 0, t.opt.stopAt = 0, t.opt.mute = !0, t.hasData = !1, t.hasChanged = !0, e && jQuery.extend(t.opt, t.defaultOpt, e), t.videoID = getYTPVideoID(t.opt.videoURL).videoID, jQuery(t.playerEl).CSSAnimate({opacity: 0}, 200, function () {
                return jQuery(t).YTPGetPlayer().cueVideoByUrl(encodeURI(jQuery.mbYTPlayer.locationProtocol + "//web.archive.org/web/20180112080018/https://www.youtube.com/v/" + t.videoID), 1, t.opt.quality), jQuery.mbYTPlayer.checkForState(t), jQuery(t).optimizeDisplay(), jQuery.mbYTPlayer.getDataFromAPI(t), this
            })
        },
        getPlayer: function () {
        ...
        buildControls: function (YTPlayer) {
            ...
            if (data.showYTLogo = data.showYTLogo || data.printUrl, !jQuery("#controlBar_" + YTPlayer.id).length) {
                ...
                vURL.indexOf("http") < 0 && (vURL = jQuery.mbYTPlayer.locationProtocol + "//web.archive.org/web/20180112080018/https://www.youtube.com/watch?v=" + data.videoURL);
...
/*
     FILE ARCHIVED ON 08:00:18 Jan 12, 2018 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 07:27:50 Feb 22, 2021.
...
/*
playback timings (ms):
  LoadShardBlock: 345.651 (3)
  exclusion.robots.policy: 0.272
  captures_list: 375.793
  esindex: 0.011
  PetaboxLoader3.resolve: 140.903 (2)
  RedisCDXSource: 1.239
  PetaboxLoader3.datanode: 257.621 (4)
  CDXLines.iter: 24.139 (3)
  load_resource: 92.62
